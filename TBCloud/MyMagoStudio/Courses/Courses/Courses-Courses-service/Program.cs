...
builder.Services.AddSwaggerGen(c =>
{
    ...
    c.SwaggerDoc("CoursesCoursesDuplicateCourses", new OpenApiInfo { Description = "CoursesCoursesDuplicateCourses", Title = "CoursesCoursesDuplicateCourses Business Logic API V1", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        ...
        c.SwaggerEndpoint("/swagger/CoursesCoursesDuplicateCourses/swagger.json", "CoursesCoursesDuplicateCourses Business Logic  API V1");
